...
const description = "Wondly의 웹 도구, 데이터, 오류 제보와 개선 아이디어에 관해 문의하세요.";
export const metadata: Metadata = {
  title: "문의하기",
  description,
  alternates: { canonical: "https://wondly.net/contact" },
  openGraph: { title: "문의하기 | Wondly", description, url: "https://wondly.net/contact", images: [] },
  twitter: { card: "summary", title: "문의하기 | Wondly", description, images: [] },
};

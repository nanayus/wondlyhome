...
export default function PrivacyPage() {
  return <><SiteHeader /><main className="content-page policy-page"><header className="content-hero"><p>PRIVACY POLICY</p><h1>개인정보처리방침</h1><div className="content-lead">Wondly는 서비스 제공에 필요한 범위에서만 정보를 처리하고, 처리 목적과 방법을 투명하게 안내합니다.</div><time dateTime="2026-08-27">시행일: 2026년 8월 27일</time></header><article className="prose policy-prose">
    ...
    <h2>2. 처리하는 정보</h2><p>현재 Wondly는 회원가입 기능을 제공하지 않으며 이름, 전화번호, 주소와 같은 개인정보를 직접 요구하지 않습니다. 다만 서비스 운영 과정에서 접속 IP 주소, 브라우저와 기기 정보, 접속 일시, 방문 페이지, 이전 페이지, 페이지 내 상호작용, 오류 기록 등이 호스팅 사업자의 서버 로그 또는 Google Analytics를 통해 자동으로 처리될 수 있습니다.</p><p>이메일로 문의하면 이메일 주소와 문의 내용, 첨부한 정보가 답변과 문제 해결을 위해 처리됩니다. 주민등록번호, 금융정보 또는 그 밖의 민감한 정보는 보내지 마세요.</p>
    ...
    <h2>4. 쿠키, 이용 분석과 광고</h2><p>Wondly는 서비스 설정 유지, 이용 분석 또는 광고 제공을 위해 쿠키와 유사 기술을 사용할 수 있습니다. 쿠키는 브라우저에 저장되는 작은 정보 파일이며 브라우저 설정에서 삭제하거나 저장을 거부할 수 있습니다. 일부 쿠키를 차단하면 이용 통계의 정확도 또는 서비스의 일부 기능에 영향을 줄 수 있습니다.</p><p>Wondly는 Google Analytics 4를 사용하여 방문 페이지, 유입 경로, 기기·브라우저 정보와 서비스 내 상호작용을 분석합니다. 이 정보는 서비스 이용 현황 파악과 품질 개선을 위해 사용되며, Wondly는 Google Analytics에 이름이나 이메일 주소처럼 개인을 직접 식별하는 정보를 전송하지 않습니다. 이용자는 <a href="https://tools.google.com/dlpage/gaoptout?hl=ko" rel="noreferrer">Google Analytics 차단 브라우저 부가기능</a> 또는 브라우저의 쿠키 설정을 이용할 수 있습니다.</p><p>향후 Google AdSense 광고가 게재되는 경우 Google을 포함한 제3자 사업자는 사용자의 이전 웹사이트 방문 기록을 기반으로 광고를 제공하기 위해 쿠키를 사용할 수 있습니다. Google의 광고 쿠키를 통해 Google과 파트너는 Wondly 또는 다른 웹사이트 방문 정보를 바탕으로 광고를 제공할 수 있습니다.</p><p>사용자는 <a href="https://adssettings.google.com/" rel="noreferrer">Google 광고 설정</a>에서 맞춤형 광고를 관리하거나 해제할 수 있습니다. Google이 파트너 사이트의 정보를 사용하는 방식은 <a href="https://policies.google.com/technologies/partner-sites?hl=ko" rel="noreferrer">Google의 파트너 사이트 관련 안내</a>에서 확인할 수 있습니다.</p>
    ...
    <h2>6. 제3자 서비스</h2><p>서비스 운영을 위해 호스팅, 보안, Google Analytics 4를 통한 트래픽 분석 및 Google AdSense 광고 서비스를 이용하거나 이용할 수 있습니다. 이 과정에서 해당 사업자가 쿠키, 웹 비콘, IP 주소 또는 기타 온라인 식별자를 수집하거나 읽을 수 있습니다. Google의 데이터 처리 방식은 <a href="https://policies.google.com/technologies/partner-sites?hl=ko" rel="noreferrer">Google 서비스를 사용하는 사이트 또는 앱의 정보 사용 안내</a>에서 확인할 수 있습니다. 새로운 서비스 도입으로 처리 내용이 실질적으로 바뀌면 이 방침을 업데이트합니다.</p>
